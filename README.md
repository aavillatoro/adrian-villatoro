...
A single scrolling page with intro, projects, background, hobbies, and contact sections.

Built with Next.js, React, and TypeScript. Styling is plain CSS in one file.
